...
### 3. Writing code without necessarily knowing where it is going.
...
### 4. Creative coding is the practice of combining programming techniques with artistic expression.
...
### 5. Creative coding uses software, code and computational processes to be expressive or to create art forms.
...
### 6. Creative coding is the practice of making art with code.
...
### 7. For me Creative Coding is a method of exploring code through the lens of a designer.
...
### 8. Creative Coding is a way of learning how to program by creating visual art with computer graphics.
...
### 9. Creative coding uses programming languages to generate art and music.
...
### 10. Where the artist-programmer is primarily invested in speculation, experimentation, and iterative practice.
